    ...
    try {
        ...
        for (let seq of list.slice(-15).reverse()) {
            try {
                ...
                // 1. DETECCIÓN DEL PERFIL (1 al 5)
                // Busca específicamente "Solicitud de X" como en tu ejemplo
                ...
                // 2. EXTRAER LINK (Botón de confirmación)
                ...
                // 3. BUSCAR EN EXCEL (Correo + Perfil exacto)
                ...
                if (elLink) {
                    ...
                    if (clienteDestino) {
                        ...
                        // Si no hay match en la hoja, te llega a ti
                ...
                emailsParaPanel.push({
                    ...
                    to: correoCuenta,
                    html: `
                        <div style="background: #f0f0f0; color: #000; padding: 10px; border-bottom: 2px solid #e50914;">
                            <b>Perfil Solicitante:</b> ${perfilSolicitado || "No detectado"}
                        </div>
...
app.listen(PORT, "0.0.0.0", () => { console.log("🚀 Lector de Solicitudes 1-5 Activo"); });
